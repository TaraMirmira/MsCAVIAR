...
info='t='$this_tau_2'_c='$this_num_causal
...
for j in $(seq 1 $num_repeat); do
    ...
    python3 /u/home/h/helenhua/project-zarlab/MSCAVIAR_SIMULATIONS/Simulations/ld_simulate_helen_v3.py -l1 ${ld_dir}/${pop1}.ld -l2 ${ld_dir}/${pop2}.ld -o $sim_dir -c $this_num_causal -s $num_sim -t $this_tau_2
    ...
    for k in $(seq 1 $num_sim); do
        ...
        /u/home/h/helenhua/project-zarlab/MSCAVIAR_SIMULATIONS/Automation/MsCAVIAR -l ${sim_dir}/ld_${k}.txt -z ${sim_dir}/gwas_${k}.txt -o ${out_dir}/mscaviar_${info}'_'$k -t $this_tau_2 -c $this_num_causal
        ...
        caviar_result1=${out_dir}/'caviar_'${pop1}${info}'_'$k'_set.txt'
        caviar_result2=${out_dir}/'caviar_'${pop2}${info}'_'$k'_set.txt'
